	...
	<div class="modal-overlay">
		<div class="modal-content">
			<div class="modal-header">
				<h1 id="intro-modal-title">Welcome to the Commons</h1>
			</div>
			...
			<div id="intro-modal-content" class="modal-body">
				...
				<section class="modal-section">
					...
					<p>This isn't about control—it's about care.</p>
				</section>
				...
				<section class="modal-section">
					<h2>Support</h2>
					<p>
						This project is free forever. If it helps you, consider sharing it or leaving a tip via
						the <a href={EXTERNAL_URLS.BUY_ME_COFFEE} target="_blank" rel="noreferrer"
							>☕ Buy Me a Coffee</a
						>.
					</p>
				</section>
